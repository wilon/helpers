...
if (! function_exists('timeDebug')) {
     ...
     * @return array
     */
    function timeDebug(string $mark = null, $echo = true, string $separate = '')
    {
        global $timeDebug;
...
if (! function_exists('getCertInfo')) {
     ...
     * @return array
     */
    function getCertInfo(string $domain)
    {
...
if (! function_exists('simpleCurl')) {
     ...
     * @return mix
     */
    function simpleCurl(string $url, array $param = [])
    {
        // params init
        if (!$url) return false;
